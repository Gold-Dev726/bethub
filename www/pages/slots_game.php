...
<script type="text/javascript" src="https://casino.cur.a8r.games/public/sg.js"></script>
...
<div id="game_wrapper_c">
  <div id="game_wrapper">
    <div class="btns hide_if_battle" id="game_wrapper_btns">
      <div>
        <button class="theme" onclick="startPlaying('real')">
...
<script type="text/javascript">
  ...
  let BACKEND_URL = isDebug ? `http://${isDebug}` : 'https://bethub.gg:2053';
  let isFs = false;
  let gm = '';
  ...
  let loadGameSlots = () => {
    setTimeout(() => {
      ...
      send_request_socket({
        ...
        'game': `${SLOTS_GAME_PROVIDER}:${SLOTS_GAME_ID}`,
      });
    }, 500);
  }
  ...
  let launchGame = options => {
    ...
    gameLaunchOptions['launch_options'] = options;
